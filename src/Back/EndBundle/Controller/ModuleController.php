...
use Back\EndBundle\Entity\Module;
...
class ModuleController extends Controller
{
    ...
    {
        $module = new Module();
        $form = $this->createForm('Back\EndBundle\Form\ModuleType', $module);
    ...
    {
        $deleteForm = $this->createDeleteForm($module);
        $editForm = $this->createForm('Back\EndBundle\Form\ModuleType', $module);
